...
struct RecordJourneyView: View {
            ...
            VStack(spacing: 20) {
                ...
                Button {
                    ...
                    Text(model.location.isRecording ? "Stop & Save" : "Start Recording")
                        ...
                        .padding()
                        .background(model.location.isRecording ? Color.red : Color.accentColor, in: RoundedRectangle(cornerRadius: 14))
    ...
    private func stop(){
        ...
        // TODO: persist `journey` once AppModel has a journeys store.
        _ = journey
        dismiss()
    }
}
